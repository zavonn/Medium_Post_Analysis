...
# Medium Article Word Count Analysis (<a href="https://nbviewer.jupyter.org/github/zavonn/Medium_Post_Analysis/blob/master/MediumPostAnalysis.ipynb">Click here for the Interactive Jupyter Notebook</a>)
